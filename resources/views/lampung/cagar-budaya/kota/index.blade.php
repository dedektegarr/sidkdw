...
{{-- @section('breadcrumbs', Breadcrumbs::render('lampung.cb-kabupaten-kota')) --}}
@section('content')
    <a href="{{ route('lampung.cb-kabupaten-kota.create') }}"
        ...
        <tbody>
            @foreach ($data_cb as $cb)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('lampung.cb-kabupaten-kota.edit', $cb->id) }}"
