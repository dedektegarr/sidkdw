...
@section('page', 'Cagar Budaya Kabupaten / Kota')
@section('breadcrumbs', Breadcrumbs::render('bengkulu.cb-kabupaten-kota'))
@section('content')
    <a href="{{ route('bengkulu.cb-kabupaten-kota.create') }}"
        ...
        <tbody>
            @foreach ($data_cb as $cb)
                <tr>
                    ...
                    <td>{{ $cb->jenis->nama }}</td>
                    <td>{{ $cb->status->nama }}</td>
                    <td>{{ $cb->sk_penetapan }}</td>
                    <td>{{ $cb->desa_kelurahan }}</td>
                    <td>{{ $cb->kecamatan }}</td>
                    <td>{{ $cb->kabupaten_kota }}</td>
                    <td>
                        <a href="{{ route('bengkulu.cb-kabupaten-kota.edit', $cb->id) }}"
